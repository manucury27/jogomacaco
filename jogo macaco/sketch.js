...
function gerarNuvens(){
 ...
 function gerarSerpente(){
  if(frameCount %300 === 0){
    serpente = createSprite(width -900,height-100,40,10);
 ...
 function gerarPorcoespinho(){
  if(frameCount %120 === 0){
    porcoespinho = createSprite(width -900,height-50,40,10);
   porcoespinho.x = Math.round(random(width -100,width -900));
...
function gerarMirtilo(){
  if(frameCount %120 === 0){
   mirtilo = createSprite(Math.round(random(width -50,width -900)), Math.round(random(width -100,width -900)),40,10);
